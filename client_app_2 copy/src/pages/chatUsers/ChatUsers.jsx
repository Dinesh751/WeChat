...
import { FaWeixin } from 'react-icons/fa'; // Importing a React Icon for WeChat
      ...
      <div className="chatUserContainer">
        <div className="headerTitleContainer">
          <h4 className="header-title">
            <FaWeixin style={{ marginRight: "8px", color: "#fff" }} />
            WeChat
          </h4>
        </div>
        ...
        <div className="containerUser">
          {users.map((user) => (
            user.userName !== auth.user.userName && (
              <div
                className={`usersContainer ${receiver === user.userName ? "active" : ""}`}
                key={user._id}
        ...
        <div className="footerContainer">
          {auth?.user?.profilePhoto ? (
            <img src={auth.user.profilePhoto} alt="user-profile" />
          ) : (
            <div
              className="profile-initials"
              style={{
                backgroundColor: generateColorFromName(auth?.user?.userName || "User"),
                color: "#fff",
                display: "flex",
                justifyContent: "center",
                alignItems: "center",
